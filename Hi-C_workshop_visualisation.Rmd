...
[Cooltools](https://cooltools.readthedocs.io/en/latest/index.html#) is also a highly recommended package.

For [Micro-C analysis](https://micro-c.readthedocs.io/en/latest/index.html)

A useful exhaustive list of further tools [here](https://github.com/mdozmorov/HiC_tools).
